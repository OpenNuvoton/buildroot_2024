...
LINUX_HEADERS_CUSTOM_NAME = MA35D1_linux-5.10.y
...
LINUX_HEADERS_CUSTOM_NAME = MA35D1_linux-6.6.y
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(BR2_LINUX_KERNEL_MA35))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call github,OpenNuvoton,$(call qstrip,$(LINUX_HEADERS_CUSTOM_NAME)),$(call qstrip,$(BR2_TARGET_KERNEL_MA35_VERSION)))/MA35D1_linux-6.6.y-$(call qstrip,$(BR2_TARGET_KERNEL_MA35_VERSION)).tar.gz
LINUX_HEADERS_SOURCE = $(notdir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_SITE = $(patsubst %/,%,$(dir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION)))
else ifeq ($(BR2_LINUX_KERNEL_NUC980_5_10_VERSION),y)
LINUX_HEADERS_CUSTOM_NAME = NUC980-linux-5.10.y
...
LINUX_HEADERS_CUSTOM_NAME = NUC980-linux-6.6.y
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(BR2_LINUX_KERNEL_NUC980))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call github,OpenNuvoton,$(call qstrip,$(LINUX_HEADERS_CUSTOM_NAME)),$(call qstrip,$(BR2_TARGET_KERNEL_NUC980_VERSION)))/NUC980-linux-6.6.y-$(call qstrip,$(BR2_TARGET_KERNEL_NUC980_VERSION)).tar.gz
LINUX_HEADERS_SOURCE = $(notdir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_SITE = $(patsubst %/,%,$(dir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION)))
else ifeq ($(BR2_LINUX_KERNEL_MA35_5_4_VERSION),y)
LINUX_HEADERS_CUSTOM_NAME = MA35D1_linux-5.4.y
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(BR2_LINUX_KERNEL_MA35))
...
# BR2_BACKUP_SITE = $(call github,OpenNuvoton,$(call qstrip,$(LINUX_HEADERS_CUSTOM_NAME))-beta,master)
